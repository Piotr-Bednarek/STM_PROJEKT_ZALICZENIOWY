...
//		if (distance == 0xFFFF) {
//			HAL_UART_Transmit(&huart3, (uint8_t*)"Error reading distance\r\n", 24, 100);
//		} else {
...
//		HAL_Delay(100);
		...
		// test MAX
		Servo_SetAngle(&servo, 70);
		HAL_Delay(250);
		Servo_SetAngle(&servo, 130);
		HAL_Delay(250);

		// Test: Płynne przejście od 0 do 200 stopni
...
//		HAL_Delay(500);
//
//		// Test: Płynne przejście od 200 do 0 stopni
