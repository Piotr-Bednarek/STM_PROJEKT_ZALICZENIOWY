% ROZDZIAŁ 4: Wyniki eksperymentalne i walidacja modeli
\chapter{Wyniki eksperymentalne i walidacja modeli}
\label{ch:wyniki}

W niniejszym rozdziale przedstawiono wyniki badań eksperymentalnych
przeprowadzonych na rzeczywistym stanowisku laboratoryjnym "Ball on Beam"
oraz ich porównanie z wynikami symulacji komputerowych. Badania miały na celu
walidację wyznaczonych modeli matematycznych (teoretycznego oraz
doświadczalnego) w układzie zamkniętym sprzężenia zwrotnego.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{../../5-matlab/proba1_plots.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{../../5-matlab/proba2_plots.png}
    \caption{Przebiegi czasowe pozycji kulki oraz sygnału sterującego
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{img/ballonbeam_matlab1.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../../5-matlab/odpowiedz_proba1_teoretyczny.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../../5-matlab/odpowiedz_proba1_doswiadczalny.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../../5-matlab/sterowanie_proba1_teoretyczny.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../../5-matlab/sterowanie_proba1_doswiadczalny.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../../5-matlab/odpowiedz_proba2_teoretyczny.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../../5-matlab/odpowiedz_proba2_doswiadczalny.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../../5-matlab/sterowanie_proba2_teoretyczny.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../../5-matlab/sterowanie_proba2_doswiadczalny.pdf}
...
Na podstawie uzyskanych przebiegów czasowych przedstawionych na wykresach oraz
ilościowych wskaźników jakości zestawionych w tabeli~\ref{tab:wskazniki} można
...
proporcjonalnego ($P = K_p \cdot e$). W próbie 1, przy uchybie początkowym
$e = 48$~mm, teoretyczna wartość członu P wynosi $0.26 \cdot 48 \approx 12.48^{\circ}$,
co idealnie koresponduje z zarejestrowanym pikiem sterowania. Fakt ten stanowi
...
Po początkowym piku sygnały sterujące ulegają jednak wyraźnemu rozbieżnieniu. Na
...
wpada w silne oscylacje wokół setpointu. W efekcie regulator w symulacji próbuje
...
skoku w dół) w porównaniu do symulacji komputerowych. Wynika to z faktu, że
...
w stosunku do dynamiki całego układu. Wpływ całki na dominantną parę biegunów
...
częstotliwości (tzw. szpilki). W kodzie mikrokontrolera (plik \texttt{servo\_pid.c})
...
\subsection{Porównanie ostateczne i ocena dokładności modeli}
