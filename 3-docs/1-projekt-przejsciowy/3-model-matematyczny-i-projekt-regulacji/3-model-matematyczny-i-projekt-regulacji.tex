...
\begin{itemize}
  ...
  \item $\Theta$ - kąt nachylenia równi
\end{itemize}
...
\begin{equation}
    K = 11{,}9318\;\frac{\mathrm{mm}}{\mathrm{s}^2 \cdot {^\circ}}.
    \label{eq:Kfinal}
\end{equation}
...
\hline
$T_\mathrm{serwo}$  & $0{,}095$ & $\mathrm{s}$ & karta katalogowa, interpolacja \\[4pt]
$c_\mathrm{ball}$   & $5{,}886$ & $\dfrac{\mathrm{m}}{\mathrm{s}^2 \cdot \mathrm{rad}}$ & wyprowadzenie analityczne \\[8pt]
$k_\mathrm{mech}$   & $0{,}20$  & $-$ & pomiar geometryczny ($3\;\mathrm{cm}/15\;\mathrm{cm}$) \\[4pt]
$K_\mathrm{exp}$    & $11{,}9318$ & $\dfrac{\mathrm{mm}}{\mathrm{s}^2 \cdot {^\circ}}$ & identyfikacja doświadczalna \\[8pt]
$K_\mathrm{exp,SI}$ & $0{,}684$ & $\dfrac{\mathrm{m}}{\mathrm{s}^2 \cdot \mathrm{rad}}$ & przeliczenie z $K_\mathrm{exp}$ \\[4pt]
\hline
\end{tabular}
\end{table}
TODO dokonczyc te sekcje!!! - tabela jeszcze do zmiany 
