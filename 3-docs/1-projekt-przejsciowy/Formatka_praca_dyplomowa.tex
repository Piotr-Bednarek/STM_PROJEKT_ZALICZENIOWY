...
\usepackage{array}    % rozszerzona obsługa kolumn tabel (>{...}, \arraybackslash)
...
\newpage\null\thispagestyle{empty}\newpage
 ...
 % Streszczenie \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
    ...
    MG946R, kamera systemu wizyjnego, potencjometr) oraz
    ...
    Przeprowadzono weryfikację eksperymentalną i~potwierdzono zgodność zachowania fizycznego
    systemu z wyznaczonym modelem.
    }
    \vspace*{1\baselineskip}

    \noindent{\bf Słowa kluczowe}: {\itshape regulacja automatyczna, kulka na belce,
    STM32, PID, LQR, FreeRTOS, systemy wizyjne.}
    \par
  ...
  % Abstract \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
    ...
    The mechanical setup, hardware peripherals (MG946R servo, computer vision camera
    , potentiometer), and FreeRTOS-based software architecture are
    described.
    ...
    Experimental verification confirms that physical system behaves the same as the theoretical model.
    }
    \vspace*{1\baselineskip}

    \noindent{\bf Key words}: {\itshape automatic control, ball and beam, STM32, PID,
    LQR, FreeRTOS, computer vision.}
